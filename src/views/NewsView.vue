<template>
          ...
          <div class="flex flex-col">
            ...
            <div class="relative flex space-x-2">
              <input type="text" v-model="searchRequest.title"
                     class="block w-full text-sm text-gray-900 border border-gray-300 rounded-md bg-gray-50 dark:bg-gray-900 dark:text-gray-400 dark:focus:ring-blue-400 dark:border-gray-300"
                     required="required">
              <div v-if="this.isSearch" @click="clearSearch()"
                   class="mr-2 h-9 w-14 hover:text-gray-500 flex justify-center items-center bg-white border dark:hover:text-gray-300 hover:border-blue-500 transition-all ease-linear cursor-pointer rounded-md dark:bg-gray-900 dark:text-gray-500 dark:hover:border-blue-500">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                  <path fill-rule="evenodd" d="M5.47 5.47a.75.75 0 011.06 0L12 10.94l5.47-5.47a.75.75 0 111.06 1.06L13.06 12l5.47 5.47a.75.75 0 11-1.06 1.06L12 13.06l-5.47 5.47a.75.75 0 01-1.06-1.06L10.94 12 5.47 6.53a.75.75 0 010-1.06z" clip-rule="evenodd" />
                </svg>
              </div>
              <div @click="searchQuery()"
                   class="mr-2 h-9 w-14 hover:text-gray-500 flex justify-center items-center bg-white border dark:hover:text-gray-300 hover:border-blue-500 transition-all ease-linear cursor-pointer rounded-md dark:bg-gray-900 dark:text-gray-400 dark:hover:border-blue-500">
          ...
          <div v-if="!isSearch" class="flex flex-col text-gray-700 space-x-2 2xl:items-end xl:items-end lg:items-end md:items-end items-center">
            ...
            <div class="flex">
              <div :title="$t('others.goto-start')" @click="goToPage(1)"
                   class="mr-2 h-9 w-9 flex justify-center items-center bg-white border hover:text-gray-500 dark:hover:text-gray-300 hover:border-blue-500 transition-all ease-linear cursor-pointer rounded-md dark:bg-gray-900 dark:text-gray-500 dark:hover:border-blue-500">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              ...
              <div class="flex space-x-2">
                <div v-for="page in visiblePages" :key="page" @click="goToPage(page)"
                     ...
                     class="h-9 w-9 flex justify-center items-center bg-white border hover:border-blue-500 dark:hover:text-gray-300 transition-all ease-linear cursor-pointer rounded-md dark:bg-gray-900 dark:text-gray-500 dark:hover:border-blue-500">
                  {{ page }}
                </div>
              </div>
              <div :title="$t('others.goto-end')" @click="goToPage(this.endIndex)"
                   class="ml-2 h-9 w-9 flex justify-center items-center bg-white border hover:text-gray-500 dark:hover:text-gray-300 hover:border-blue-500 transition-all ease-linear cursor-pointer rounded-md dark:bg-gray-900 dark:text-gray-500 dark:hover:border-blue-500">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                     stroke="currentColor" class="w-5 h-5">
                  <path stroke-linecap="round" stroke-linejoin="round"
              ...
              <div class="relative">
                <div @click="toogleSettings()"
                     :class="{'bg-blue-500 text-white' : showSettings === true}"
                     class="ml-2 h-9 w-9 flex justify-center items-center border hover:text-gray-500 dark:hover:text-gray-300 hover:border-blue-500 transition-all ease-linear cursor-pointer rounded-md dark:bg-gray-900 dark:text-gray-500 dark:hover:border-blue-500">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                <div v-if="showSettings"
                  ...
                  <div class="flex space-x-2">
                    <div @click="changeView(8)" :class="{ 'text-gray-500 border-blue-500 dark:border-blue-500': this.itemsPerPage === '8' }"
                         class="h-9 w-9 flex justify-center items-center border hover:text-gray-500 dark:hover:text-gray-300 hover:border-blue-500 transition-all ease-linear cursor-pointer rounded-md dark:bg-gray-900 dark:text-gray-500 dark:hover:border-blue-500">
                      8
                    </div>
                    <div @click="changeView(16)" :class="{ 'text-gray-500 border-blue-500 dark:border-blue-500': this.itemsPerPage === '16' }"
                         class="h-9 w-9 flex justify-center items-center border hover:text-gray-500 dark:hover:text-gray-300 hover:border-blue-500 transition-all ease-linear cursor-pointer rounded-md dark:bg-gray-900 dark:text-gray-500 dark:hover:border-blue-500">
                      16
                    </div>
                    <div @click="changeView(32)" :class="{ 'text-gray-500 border-blue-500 dark:border-blue-500': this.itemsPerPage === '32' }"
                         class="h-9 w-9 flex justify-center items-center border hover:text-gray-500 dark:hover:text-gray-300 hover:border-blue-500 transition-all ease-linear cursor-pointer rounded-md dark:bg-gray-900 dark:text-gray-500 dark:hover:border-blue-500">
                      32
                    </div>
                  </div>
      ...
      <div class="mb-10 2xl:mx-0 xl:mx-0 lg:mx-0 mx-2">
        <div
            ...
            <NewsBlock @click="storeNews(item.id)" v-for="item in this.newsData" :key="item.id" :title="
  ...
  export default {
    ...
    methods: {
      storeNews(item) {
        sessionStorage.setItem("NEWS_ID", item);
      ...
      clearSearch() {
        ...
        this.axios.get(`/api/Depo/GetLastPageNumberDepoNews/{pageSize}/${this.itemsPerPage}`)
            .then(response => {
            ...
            .finally(() => {
              this.axios.get(`/api/Depo/GetDepoNewsByPageNumber/1/${this.itemsPerPage}`)
                  .then(response => {
      ...
      searchQuery() {
        this.loading = true;
        this.axios.post(`/api/Depo/GetNewsBySearchParameters`, this.searchRequest)
            .then(response => {
              this.newsData = response.data;
              this.isSearch = true;
            })
      ...
      goToPage(pageNumber) {
        this.loading = true;
        this.axios.get(`/api/Depo/GetDepoNewsByPageNumber/${pageNumber}/${this.itemsPerPage}`)
            .then(response => {
              this.newsData = response.data;
            })
            .catch(error => {
